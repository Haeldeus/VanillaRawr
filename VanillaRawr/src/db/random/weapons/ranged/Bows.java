...
/*		System.out.println(list.get(0));
	...
	private static void fillQuillfireBow() {
		...
		quillfireBow.createTree(" of Agility", quillfireBow.createSubTree(Stat.Agility, 7, 8), null, 5.5));
		quillfireBow.createTree(" of Marksmanship", quillfireBow.createSubTree(Stat.RangedAttackPower, 17, 31), null, 2.7));
		quillfireBow.createTree(" of Spirit", quillfireBow.createSubTree(Stat.Spirit, 7, 8), null, 6.5));
		quillfireBow.createTree(" of Stamina", quillfireBow.createSubTree(Stat.Stamina, 7, 8), null, 6.1));
		
		quillfireBow.createTree(" of the Eagle", quillfireBow.createSubTree(Stat.Intellect, 4, 5), quillfireBow.createSubTree(Stat.Stamina, 4, 5), 12.7));
		quillfireBow.createTree(" of the Falcon", quillfireBow.createSubTree(Stat.Agility, 4, 5), quillfireBow.createSubTree(Stat.Intellect, 4, 5), 11.0));
		quillfireBow.createTree(" of the Monkey", quillfireBow.createSubTree(Stat.Agility, 4, 5), quillfireBow.createSubTree(Stat.Stamina, 4, 5), 9.5));
		quillfireBow.createTree(" of the Owl", quillfireBow.createSubTree(Stat.Intellect, 4, 5), quillfireBow.createSubTree(Stat.Spirit, 4, 5), 12.9));
		quillfireBow.createTree(" of the Tiger", quillfireBow.createSubTree(Stat.Agility, 4, 5), quillfireBow.createSubTree(Stat.Strength, 4, 5), 10.0));
		quillfireBow.createTree(" of the Whale", quillfireBow.createSubTree(Stat.Spirit, 4, 5), quillfireBow.createSubTree(Stat.Stamina, 4, 5), 12.0));
		quillfireBow.createTree(" of the Wolf", quillfireBow.createSubTree(Stat.Agility, 4, 5), quillfireBow.createSubTree(Stat.Spirit, 4, 5), 11.2));
