...
public class OneHandSwords {
	...
	private static void fillWidowBlade() {
		...
		widowBlade.addToList(widowBlade.createTree(" of Power", widowBlade.createSubTree(Stat.AttackPower, 18, 20), null, 5.8));
		widowBlade.addToList(widowBlade.createTree(" of Stamina", widowBlade.createSubTree(Stat.Stamina, 9, 10), null, 6.1));
		widowBlade.addToList(widowBlade.createTree(" of Strength", widowBlade.createSubTree(Stat.Strength, 9, 10), null, 7.0));
		
		widowBlade.addToList(widowBlade.createTree(" of the Bear", widowBlade.createSubTree(Stat.Stamina, 6, 6), widowBlade.createSubTree(Stat.Strength, 6, 6), 29.2));
		widowBlade.addToList(widowBlade.createTree(" of the Monkey", widowBlade.createSubTree(Stat.Agility, 6, 6), widowBlade.createSubTree(Stat.Stamina, 6, 6), 25.0));
		widowBlade.addToList(widowBlade.createTree(" of the Tiger", widowBlade.createSubTree(Stat.Agility, 6, 6), widowBlade.createSubTree(Stat.Strength, 6, 6), 26.9));
		list.add(widowBlade);
	}
	...
	private static void fillVikingSword() {
		...
		vikingSword.addToList(vikingSword.createTree(" of Power", vikingSword.createSubTree(Stat.AttackPower, 8, 12), null, 6.0));
		vikingSword.addToList(vikingSword.createTree(" of Stamina", vikingSword.createSubTree(Stat.Stamina, 4, 5), null, 5.7));
		vikingSword.addToList(vikingSword.createTree(" of Strength", vikingSword.createSubTree(Stat.Strength, 4, 5), null, 6.7));
		
		vikingSword.addToList(vikingSword.createTree(" of the Bear", vikingSword.createSubTree(Stat.Stamina, 2, 3), vikingSword.createSubTree(Stat.Strength, 2, 3), 27.9));
		vikingSword.addToList(vikingSword.createTree(" of the Monkey", vikingSword.createSubTree(Stat.Agility, 2, 3), vikingSword.createSubTree(Stat.Stamina, 2, 3), 26.3));
		vikingSword.addToList(vikingSword.createTree(" of the Tiger", vikingSword.createSubTree(Stat.Agility, 2, 3), vikingSword.createSubTree(Stat.Strength, 2, 3), 27.4));
	...
	private static void fillRuneSword() {
		...
		runeSword.addToList(runeSword.createTree(" of Power", runeSword.createSubTree(Stat.AttackPower, 18, 18), null, 5.9));
		runeSword.addToList(runeSword.createTree(" of Stamina", runeSword.createSubTree(Stat.Stamina, 9, 9), null, 5.8));
		runeSword.addToList(runeSword.createTree(" of Strength", runeSword.createSubTree(Stat.Strength, 9, 9), null, 7.2));
		
		runeSword.addToList(runeSword.createTree(" of the Bear", runeSword.createSubTree(Stat.Stamina, 5, 6), runeSword.createSubTree(Stat.Strength, 5, 6), 29.9));
		runeSword.addToList(runeSword.createTree(" of the Monkey", runeSword.createSubTree(Stat.Agility, 5, 6), runeSword.createSubTree(Stat.Stamina, 5, 6), 24.6));
		runeSword.addToList(runeSword.createTree(" of the Tiger", runeSword.createSubTree(Stat.Agility, 5, 6), runeSword.createSubTree(Stat.Strength, 5, 6), 26.7));
		list.add(runeSword);
	}
	...
	private static void fillRaiderShortsword() {
		...
		raiderShortsword.addToList(raiderShortsword.createTree(" of Power", raiderShortsword.createSubTree(Stat.AttackPower, 4, 6), null, 19.4));
		raiderShortsword.addToList(raiderShortsword.createTree(" of Stamina", raiderShortsword.createSubTree(Stat.Stamina, 2, 2), null, 38.1));
		raiderShortsword.addToList(raiderShortsword.createTree(" of Strength", raiderShortsword.createSubTree(Stat.Strength, 2, 2), null, 42.5));
