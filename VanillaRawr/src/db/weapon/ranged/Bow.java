...
public class Bow {
  ...
  /**
   * Returns all IDs, that are used by Bows.
   * @return  An Array of Integers, that represents all IDs, that are used by Bows.
   * @since 1.0
   */
  ...
  /**
   * Returns all Icons, that are used by Bows.
   * @return  An Array of Strings, that represents all Icons, that are used by Bows by stating 
   *     their Name.
   * @since 1.0
   */
  ...
  /**
   * Returns all Names of Bows in the Game.
   * @return  The Name of all Bows in the Game as an Array of Strings.
   * @since 1.0
   */
