...
public class Wand {
  ...
  /**
   * Returns all IDs, that are used by Wands.
   * @return  An Array of Integers, that represents all IDs, that are used by Wands.
   * @since 1.0
   */
  ...
  /**
   * Returns all Icons, that are used by Wands.
   * @return  An Array of Strings, that represents all Icons, that are used by Wands by stating 
   *     their Name.
   * @since 1.0
   */
  ...
  /**
   * Returns all Names of Wands in the Game.
   * @return  The Name of all Wands in the Game as an Array of Strings.
   * @since 1.0
   */
