...
public class Gun {
  ...
  /**
   * Returns all IDs, that are used by Guns.
   * @return  An Array of Integers, that represents all IDs, that are used by Guns.
   * @since 1.0
   */
  ...
  /**
   * Returns all Icons, that are used by Guns.
   * @return  An Array of Strings, that represents all Icons, that are used by Guns by stating 
   *     their Name.
   * @since 1.0
   */
  ...
  /**
   * Returns all Names of Guns in the Game.
   * @return  The Name of all Guns in the Game as an Array of Strings.
   * @since 1.0
   */
