...
public class MainFrame {
  ...
  private void addShouldersButton(Container content) {
    ...
    btnShoulder.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(2);
        btnShoulder.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_shoulder_23.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnShoulder.setBackground(Color.LIGHT_GRAY);
        lblShoulderBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnShoulder.setBackground(frame.getBackground());
        lblShoulderBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));
      }
    ...
    btnShoulderEnch.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        btnShoulderEnch.setBackground(Color.LIGHT_GRAY);
        btnShoulderEnch.setBorder(
            BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnShoulderEnch.setBackground(frame.getBackground());
        btnShoulderEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addCloakButton(Container content) {
    ...
    btnCloak.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(3);
        btnCloak.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_misc_cape_16.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnCloak.setBackground(Color.LIGHT_GRAY);
        lblCloakBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnCloak.setBackground(frame.getBackground());
        lblCloakBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));
      }
    ...
    btnCloakEnch.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        btnCloakEnch.setBackground(Color.LIGHT_GRAY);
        btnCloakEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnCloakEnch.setBackground(frame.getBackground());
        btnCloakEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addChestButton(Container content) {
    ...
    btnChest.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(4);
        btnChest.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_chest_cloth_43.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnChest.setBackground(Color.LIGHT_GRAY);
        lblChestBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnChest.setBackground(frame.getBackground());
        lblChestBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));
      }
    ...
    btnChestEnch.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        btnChestEnch.setBackground(Color.LIGHT_GRAY);
        btnChestEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnChestEnch.setBackground(frame.getBackground());
        btnChestEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addShirtButton(Container content) {
    ...
    btnShirt.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(5);
        btnShirt.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_shirt_blue_01.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnShirt.setBackground(Color.LIGHT_GRAY);
        lblShirtBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 2, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnShirt.setBackground(frame.getBackground());
        lblShirtBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addTabardButton(Container content) {
    ...
    btnTabard.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(6);
        btnTabard.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_shirt_guildtabard_01.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnTabard.setBackground(Color.LIGHT_GRAY);
        lblTabardBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 2, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnTabard.setBackground(frame.getBackground());
        lblTabardBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addBracerButton(Container content) {
    ...
    btnBracer.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(7);
        btnBracer.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_bracer_33.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnBracer.setBackground(Color.LIGHT_GRAY);
        lblBracerBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnBracer.setBackground(frame.getBackground());
        lblBracerBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));
      }
    ...
    btnBracerEnch.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        btnBracerEnch.setBackground(Color.LIGHT_GRAY);
        btnBracerEnch.setBorder(
            BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnBracerEnch.setBackground(frame.getBackground());
        btnBracerEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addMainHandButton(Container content) {
    ...
    btnMainHand.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(16);
        btnMainHand.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_mace_21.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnMainHand.setBackground(Color.LIGHT_GRAY);
        lblMainHandBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnMainHand.setBackground(frame.getBackground());
        lblMainHandBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));
      }
    ...
    btnMainHandEnch.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        btnMainHandEnch.setBackground(Color.LIGHT_GRAY);
        btnMainHandEnch.setBorder(
            BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnMainHandEnch.setBackground(frame.getBackground());
        btnMainHandEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addOffHandButton(Container content) {
    ...
    btnOffHand.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(17); 
        btnOffHand.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_offhand_naxxramas_02.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnOffHand.setBackground(Color.LIGHT_GRAY);
        lblOffHandBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnOffHand.setBackground(frame.getBackground());
        lblOffHandBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));
      }
    ...
    btnOffHandEnch.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        btnOffHandEnch.setBackground(Color.LIGHT_GRAY);
        btnOffHandEnch.setBorder(
            BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnOffHandEnch.setBackground(frame.getBackground());
        btnOffHandEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addRangedButton(Container content) {
    ...
    btnRanged.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(18);
        btnRanged.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_wand_11.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnRanged.setBackground(Color.LIGHT_GRAY);
        if (hasRangedEnch()) {
          lblRangedBorder.setBorder(
              BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));
        } else {
          lblRangedBorder.setBorder(
              BorderFactory.createMatteBorder(2, 2, 2, 2, Color.blue.brighter()));
      ...
      public void mouseExited(MouseEvent arg0) {
        btnRanged.setBackground(frame.getBackground());
        if (hasRangedEnch()) {
          lblRangedBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));
        } else {
    ...
    btnRangedEnch.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        btnRangedEnch.setBackground(Color.LIGHT_GRAY);
        btnRangedEnch.setBorder(
            BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnRangedEnch.setBackground(frame.getBackground());
        btnRangedEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addAmmoButton(Container content) {
    ...
    btnAmmo.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(19);
        btnAmmo.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_ammo_arrow_01.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnAmmo.setBackground(Color.LIGHT_GRAY);
        lblAmmoBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 2, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnAmmo.setBackground(frame.getBackground());
        lblAmmoBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addGlovesButton(Container content) {
    ...
    btnGloves.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(8);
        btnGloves.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_gauntlets_21.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnGloves.setBackground(Color.LIGHT_GRAY);
        btnGlovesBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnGloves.setBackground(frame.getBackground());
        btnGlovesBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));
      }
    ...
    btnGlovesEnch.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        btnGlovesEnch.setBackground(Color.LIGHT_GRAY);
        btnGlovesEnch.setBorder(
            BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnGlovesEnch.setBackground(frame.getBackground());
        btnGlovesEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addBeltButton(Container content) {
    ...
    btnBelt.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(9);
        btnBelt.setIcon(new ImageIcon(MainFrame.class.getResource("/resources/inv_belt_08.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnBelt.setBackground(Color.LIGHT_GRAY);
        lblBeltBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 2, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnBelt.setBackground(frame.getBackground());
        lblBeltBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addPantsButton(Container content) {
    ...
    btnPants.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(10);
        btnPants.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_pants_cloth_01.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnPants.setBackground(Color.LIGHT_GRAY);
        btnPantsBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnPants.setBackground(frame.getBackground());
        btnPantsBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));
      }
    ...
    btnPantsEnch.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        btnPantsEnch.setBackground(Color.LIGHT_GRAY);
        btnPantsEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnPantsEnch.setBackground(frame.getBackground());
        btnPantsEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addFeetButton(Container content) {
    ...
    btnFeet.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(11);
        btnFeet.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_boots_cloth_11.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnFeet.setBackground(Color.LIGHT_GRAY);
        btnFeetBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnFeet.setBackground(frame.getBackground());
        btnFeetBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));
      }
    ...
    btnFeetEnch.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        btnFeetEnch.setBackground(Color.LIGHT_GRAY);
        btnFeetEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnFeetEnch.setBackground(frame.getBackground());
        btnFeetEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addUpperRingButton(Container content) {
    ...
    btnRing.addMouseListener(new MouseListener() {
      ...
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(12);
        btnRing.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_jewelry_ring_ahnqiraj_02.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnRing.setBackground(Color.LIGHT_GRAY);
        lblRingBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 2, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnRing.setBackground(frame.getBackground());
        lblRingBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addUpperTrinketButton(Container content) {
    ...
    btnTrinket.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(14);
        btnTrinket.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_jewelry_talisman_08.jpg")));
      }
      
      public void mouseEntered(MouseEvent arg0) {
        btnTrinket.setBackground(Color.LIGHT_GRAY);
        lblTrinketBorder.setBorder(
            BorderFactory.createMatteBorder(2, 2, 2, 2, Color.blue.brighter()));
      }
      
      public void mouseExited(MouseEvent arg0) {
        btnTrinket.setBackground(frame.getBackground());
        lblTrinketBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.BLACK));
      }
  ...
  private void addLowerTrinketButton(Container content) {
    ...
    btnTrinket.addMouseListener(new MouseListener() {
      public void mouseClicked(MouseEvent arg0) {
        loadHeads(15);
        btnTrinket.setIcon(new ImageIcon(
            MainFrame.class.getResource("/resources/inv_belt_02.jpg")));
      }
  ...
  private void loadHeads(int i) {
    ...
    JLabel button = null;
    switch (i) {
      case 0: button = buttons.get("Head"); 
              break;
      case 1: button = buttons.get("Neck"); 
              break;
      default: button = buttons.get("Head"); 
               break;
    }
    ...
    for (int j = 1; j <= 100; j++) {
      ...
      /*   tmp.addMouseListener(new MouseListener() {
        ...
        @Override
        public void mouseEntered(MouseEvent arg0) {
          ((ItemDisplayLayout)(tmp.getLayout())).getComponents().
            get(ItemDisplayLayout.LEFT_BORDER).setBackground(Color.cyan);
          
          ((ItemDisplayLayout)(tmp.getLayout())).getComponents().
            get(ItemDisplayLayout.RIGHT_BORDER).setBackground(Color.cyan);
          
          ((ItemDisplayLayout)(tmp.getLayout())).getComponents().
            get(ItemDisplayLayout.UPPER_BORDER).setBackground(Color.cyan);
          
          ((ItemDisplayLayout)(tmp.getLayout())).getComponents().
            get(ItemDisplayLayout.LOWER_BORDER).setBackground(Color.cyan);
  //        (tmp.getComponentAt(new Point(0,2))).setBackground(Color.cyan);
  //        (tmp.getComponentAt(new Point(2,0))).setBackground(Color.cyan);
  //        (tmp.getComponentAt(new Point(tmp.getHeight()-1, tmp.getWidth()/2))).
  //          setBackground(Color.cyan);
   * 
  //        (tmp.getComponentAt(new Point(tmp.getHeight()/2, tmp.getWidth()-1))).
   *          setBackground(Color.cyan);
        }
        ...
        public void mouseExited(MouseEvent arg0) {
          ((ItemDisplayLayout)(tmp.getLayout())).getComponents().
            get(ItemDisplayLayout.LEFT_BORDER).setBackground(Color.black);
          ((ItemDisplayLayout)(tmp.getLayout())).getComponents().
            get(ItemDisplayLayout.RIGHT_BORDER).setBackground(Color.black);
          ((ItemDisplayLayout)(tmp.getLayout())).getComponents().
            get(ItemDisplayLayout.UPPER_BORDER).setBackground(Color.black);
          ((ItemDisplayLayout)(tmp.getLayout())).getComponents().
            get(ItemDisplayLayout.LOWER_BORDER).setBackground(Color.black);
   ...
   *           setBackground(Color.black);
    ...
    pane.addMouseListener(new MouseListener() {
      ...
      public void mouseEntered(MouseEvent arg0) {
        point = arg0.getPoint();
        ((ItemDisplayLayout)(((Container)(pane.getComponentAt(point)))
    ...
    newFrame.setLocation(button.getLocationOnScreen().x + button.getWidth(), 
  ...
  private Component createTabPane() {
    ...
    //  tabPane.addTab("Null", new JLabel(new ImageIcon(
    //    MainFrame.class.getResource("/resources/mage_1.jpg"))));
