...
public class MainFrame {
	...
	private void addHeadButton(Container content) {
		...
		btnHead.addMouseListener(new MouseListener() {
			public void mouseClicked(MouseEvent arg0) {loadHeads(0); btnHead.setIcon(new ImageIcon(MainFrame.class.getResource("/resources/inv_helmet_125.jpg")));}
			public void mouseEntered(MouseEvent arg0) {btnHead.setBackground(Color.LIGHT_GRAY);lblHeadBorder.setBorder(BorderFactory.createMatteBorder(2, 2, 0, 2, Color.blue.brighter()));}
			public void mouseExited(MouseEvent arg0) {btnHead.setBackground(frame.getBackground());lblHeadBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 1, Color.BLACK));}
		...
		btnHeadEnch.addMouseListener(new MouseListener() {
			public void mouseClicked(MouseEvent arg0) {loadEnchants(0);}
			public void mouseEntered(MouseEvent arg0) {btnHeadEnch.setBackground(Color.LIGHT_GRAY);btnHeadEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.blue.brighter()));}
			public void mouseExited(MouseEvent arg0) {btnHeadEnch.setBackground(frame.getBackground());btnHeadEnch.setBorder(BorderFactory.createMatteBorder(0, 1, 1, 1, Color.BLACK));}
			public void mousePressed(MouseEvent arg0) {}
			public void mouseReleased(MouseEvent arg0) {}
		});
	...
	private void addNeckButton(Container content) {
		...
		btnNeck.addMouseListener(new MouseListener() {
			public void mouseClicked(MouseEvent arg0) {loadHeads(1); btnNeck.setIcon(new ImageIcon(MainFrame.class.getResource("/resources/inv_jewelry_necklace_27naxxramas.jpg")));}
			public void mouseEntered(MouseEvent arg0) {btnNeck.setBackground(Color.LIGHT_GRAY);lblNeckBorder.setBorder(BorderFactory.createMatteBorder(2, 2, 2, 2, Color.blue.brighter()));}
			public void mouseExited(MouseEvent arg0) {btnNeck.setBackground(frame.getBackground());lblNeckBorder.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.BLACK));}
			public void mousePressed(MouseEvent arg0) {}
			public void mouseReleased(MouseEvent arg0) {}
		});
