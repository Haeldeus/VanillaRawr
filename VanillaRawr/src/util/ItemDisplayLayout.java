...
public class ItemDisplayLayout implements LayoutManager {
	...
	public final static String UPPER_BORDER = "Upper_Border";
	
	public final static String RIGHT_BORDER = "Right_Border";
	
	public final static String LEFT_BORDER = "Left_Border";
	
	public final static String LOWER_BORDER = "Lower_Border";
	...
	private boolean isComponent(String key) {
		if (key.equals(ICON) || key.equals(NAME) || key.equals(ATTRIBUTES) || 
				key.equals(UPPER_BORDER) || key.equals(RIGHT_BORDER) || 
				key.equals(LEFT_BORDER) || key.equals(LOWER_BORDER))
			return true;
		else
			return false;
	}
